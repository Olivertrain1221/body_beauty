...
from .views import PostCreateView, TattooDetailListView, TattooListView, UpdatePostView, DeleteAPostView
...
urlpatterns = [
    ...
    path('<slug>/delete/', DeleteAPostView.as_view(), name="tattoopost_confirm_delete"),
]
